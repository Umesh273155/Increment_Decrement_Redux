...
function User1(props1) {
  ...
  return (
    <div className="user_Details_Box" style={{marginLeft: "0",marginTop:"0",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }} >
      <div className="Each_user_detailing_boxx_"  style={{marginTop:"20px",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
        <p style={{ marginBottom: "5px", marginTop: "25px" }}>{props1.selectedUsers.id}</p>
        <img src={props1.selectedUsers.image} alt="#" className="user_card" style={{ marginTop: "0px" }}></img>
        <br></br>
