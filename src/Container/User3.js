...
function User3(props1) {
  return (
    <div className="userDetails-Box"  style={{marginLeft: "0",marginTop:"0",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
      <div className="Each_user_detailing_boxx_"  style={{marginLeft: "0",marginTop:"0",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
