...
function Users1(props) {
  return (
    <div className="user_s_Box"style={{marginLeft: "0",marginTop:"20px",marginBottom:"0",marginRight:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }}>
      <div className="Each_user_details_box"style={{marginTop:"50px",marginBottom:"0",paddingLeft:"0",paddingTop:"0",paddingRight:"0",paddingBottom:"0" }} >
        ...
        <div className="user_Table">
          <div className="row">
            ...
            <p className="para2nd" style={{paddingRight:"4px"}}>1</p>
          </div>
          <div className="row">
